...
import {
  ActionLog,
  ActionTypeMeta,
} from "../../../core/models/action-log.models";
...
export class ActionLogComponent implements OnInit, OnChanges {
  ...
  @ViewChild("actionTypeTpl", { static: true })
  actionTypeTpl!: TemplateRef<any>;
  ...
  getActionTypeMeta(actionType?: string): ActionTypeMeta | undefined {
    ...
    return Object.values(enumData.ACTION_TYPE).find(
      (item) => item.code === actionType,
    );
  }
