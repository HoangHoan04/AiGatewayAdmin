...
export class AuthService {
  ...
  enableTwoFactor(code: string): Observable<any> {
    return this.apiService.post<any>(this.apiService.AUTH.TWO_FA_ENABLE, {
      code,
    });
  }

  disableTwoFactor(code: string): Observable<any> {
    return this.apiService.post<any>(this.apiService.AUTH.TWO_FA_DISABLE, {
      code,
    });
  }

  changePasswordWithTwoFactor(
    code: string,
    currentPassword: string,
    newPassword: string,
  ): Observable<any> {
    return this.apiService.post<any>(
      this.apiService.AUTH.CHANGE_PASSWORD_TWO_FA,
      {
        code,
        currentPassword,
        newPassword,
  ...
  resetPasswordWithTwoFactor(code: string, password: string): Observable<any> {
    return this.apiService.post<any>(this.apiService.AUTH.RESET_TWO_FA, {
      code,
      password,
    });
  }
  ...
  listSessions(
    body: { includeRevoked?: boolean; allUsers?: boolean } = {},
  ): Observable<any> {
    return this.apiService.post<any>(this.apiService.AUTH.SESSIONS_LIST, body);
  }

  revokeSession(id: string): Observable<any> {
    return this.apiService.post<any>(this.apiService.AUTH.SESSIONS_REVOKE, {
      id,
    });
  }
  ...
  refreshTokens(refreshToken: string): Observable<any> {
    return this.apiService
      .post<any>(this.apiService.AUTH.REFRESH, { refreshToken })
      .pipe(
        tap((res) => {
          if (res && res.token) {
  ...
  changePassword(body: any): Observable<any> {
    return this.apiService.post<any>(
      this.apiService.AUTH.CHANGE_PASSWORD,
      body,
    );
  }

  forgotPassword(email: string): Observable<any> {
    return this.apiService.post<any>(this.apiService.AUTH.FORGOT_PASSWORD, {
      email,
    });
  }
  ...
  resetPasswordWithOtp(body: any): Observable<any> {
    return this.apiService.post<any>(
      this.apiService.AUTH.RESET_PASSWORD_WITH_OTP,
      body,
    );
  }
