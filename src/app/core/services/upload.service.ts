...
export class UploadService {
  ...
  uploadSingle(file: File): Observable<UploadFileResult> {
    return this.api.uploadFile<UploadFileResult>(
      this.api.UPLOAD_FILE.UPLOAD_SINGLE,
      file,
    );
  }

  uploadMulti(files: File[]): Observable<UploadFileResult[]> {
    return this.api.uploadFiles<UploadFileResult[]>(
      this.api.UPLOAD_FILE.UPLOAD_MULTI,
      files,
    );
  }
  ...
  uploadImage(file: File): Observable<UploadFileResult> {
    return this.api.uploadFile<UploadFileResult>(
      this.api.UPLOAD_FILE.UPLOAD_IMAGE,
      file,
    );
  }
  ...
  uploadAudio(file: File): Observable<UploadFileResult> {
    return this.api.uploadFile<UploadFileResult>(
      this.api.UPLOAD_FILE.UPLOAD_AUDIO,
      file,
    );
  }
  ...
  uploadDocument(file: File): Observable<UploadFileResult> {
    return this.api.uploadFile<UploadFileResult>(
      this.api.UPLOAD_FILE.UPLOAD_DOCUMENT,
      file,
    );
  }
  ...
  uploadCatbox(file: File): Observable<UploadFileResult> {
    return this.api.uploadFile<UploadFileResult>(
      this.api.UPLOAD_FILE.UPLOAD_CATBOX,
      file,
    );
  }

  uploadCatboxFromUrl(url: string): Observable<UploadFileResult> {
    return this.api.post<UploadFileResult>(
      this.api.UPLOAD_FILE.UPLOAD_CATBOX_URL,
      { url },
    );
  }
  ...
  uploadMultiS3(files: File[]): Observable<UploadFileResult[]> {
    return this.api.uploadFiles<UploadFileResult[]>(
      this.api.UPLOAD_FILE.UPLOAD_MULTI_S3,
      files,
    );
  }
